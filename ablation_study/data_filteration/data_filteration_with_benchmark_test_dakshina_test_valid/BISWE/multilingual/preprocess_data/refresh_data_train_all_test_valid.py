...
if 'I' in data_resources[lang_train]:
    # indiccorp train data
    f_indiccorp_train = open('/nlsasfs/home/ai4bharat/manidl/yash/indic-xlit/all_data/indiccorp/threshold_0_35_files/translit_pairs_with_avg_score_thr_035_'+lang_abr_train+'.txt','r')
