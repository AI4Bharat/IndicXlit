...
if 'I' in data_resources[lang]:
    # indiccorp train data
    f_indiccorp_train = open('/nlsasfs/home/ai4bharat/manidl/yash/indic-xlit/all_data/indiccorp/threshold_0_35_files/translit_pairs_with_avg_score_thr_035_'+lang_abr+'.txt','r')
...
if 'S' in data_resources[lang]:
    ...
    f_samanantar_train = open('/nlsasfs/home/ai4bharat/manidl/yash/indic-xlit/all_data/samanantar/valid_pairs/'+lang_abr+'-en_valid.csv','r')
...
if 'W' in data_resources[lang]:
    # wikidata train data
    f_wikidata_train = open('/nlsasfs/home/ai4bharat/manidl/yash/indic-xlit/all_data/wikidata/true_pairs/'+lang_abr+'.txt','r')
...
if 'E' in data_resources[lang]:
    # existing train data
    f_existing_train = open('/nlsasfs/home/ai4bharat/manidl/yash/indic-xlit/all_data/existing_data/Indic_Xlit_translit_parallel_corpus/'+lang+'/'+lang_abr+'_train.txt','r')
