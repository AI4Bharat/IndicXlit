...
if 'I' in data_resources[lang_train]:
    ...
    f_indiccorp_train = open('/home/yashkm/indic-xlit/all_data/indiccorp/threshold_0_35_files/translit_pairs_with_avg_score_thr_035_'+lang_abr_train+'.txt','r')
...
lang_abr_test_valid_list = ['bn', 'gu', 'hi', 'mr', 'pa', 'sd', 'si', 'ur']
lang_test_valid_list = ['Bangla', 'Gujarati', 'Hindi', 'Marathi', 'Punjabi', 'Sindhi', 'Sinhala', 'Urdu']
