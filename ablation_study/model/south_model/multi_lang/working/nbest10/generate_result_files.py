...
f = open('../../output_nbest_10/en_'+lang_abr+'.txt','r')
lines = f.read().split('\n')
...
f_out = open('../../output_nbest_10/result_dict_'+lang_abr+'.json','w')
...
save_path_file = "../../output_nbest_10/translit_result_"+lang_abr+".xml"
...
save_path_file = "../../output_nbest_10/translit_test_"+lang_abr+".xml"
