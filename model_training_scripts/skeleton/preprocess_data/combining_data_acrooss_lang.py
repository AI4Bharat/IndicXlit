...
lang_abr_list = ['as', 'bn', 'brx', 'gom', 'gu', 'hi', 'kn', 'ks', 'mai', 'ml', 'mni', 'mr', 'ne', 'or', 'pa', 'sa', 'ta', 'te', 'ur', 'sd', 'si']
lang_list = ['Assamese', 'Bangla', 'Bodo', 'Konkani', 'Gujarati', 'Hindi', 'Kannada', 'Kashmiri', 'Maithili', 'Malayalam', 'Manipuri', 'Marathi', 'Nepali', 'Oriya', 'Punjabi', 'Sanskrit', 'Tamil', 'Telugu', 'Urdu', 'Sindhi', 'Sinhala']
