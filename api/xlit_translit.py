...
class Model:
    ...
    def __init__(self, expdir, beam, nbest):
        ...
        self.transliterator = Transliterator(
            f"{expdir}/corpus-bin", f"{expdir}/transformer/checkpoint_best.pt", beam, nbest, batch_size = 32
        )
        

        # loading the word_prob_dict for rescoring module
        self.word_prob_dict_wrapped_dict = {
            target_lang_key : json.load(open(f"{expdir}/word_prob_dicts/{target_lang_key}_word_prob_dict.json", 'r'))
